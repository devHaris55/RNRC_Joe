                            ...
                            <input type="hidden" value="{{$appointment->form_type}}" name="form_type">
                                <div class="mb-4">
                                    ...
                                    <select name="event_id" class="form-control">
                                        <option value="null" {{$appointment->event_id == null ? 'selected':''}}>Not assigned</option>
                                        @foreach($event as $ev)
                                            <option value="{{$ev->id}}" {{$appointment->event_id == $ev->id ? 'selected':''}}> {{$ev->title}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="mb-4">
                                    <label for="title">First Name</label>
                                    <input type="text" name="first_name" class="form-control" value="{{ $appointment->first_name }}" required  id="exampleInputPassword1">
                                </div>
                                <div class="mb-4">
                                    <label for="title">Last Name</label>
                                    <input type="text" name="last_name" class="form-control" value="{{ $appointment->last_name }}" required  id="exampleInputPassword1">
                                </div>
                                <div class="mb-4">
